	...
	return (
		<div className="container mx-auto pt-8">
			...
			<div className="mt-6 content-center" style={{ backgroundColor: '#424242' }}>
				<div className="flex items-stretch grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 grid-cols-2 lg:gap-15 sm:gap-5 gap-2 p-4">
					<div>
						<img src={vincenian1.src} alt="" />
						<div className="m-2 text-center bg-yellow-800 text-sm p-2 flex self-stretch items-start h-40">
					...
					<div>
						<img src={vincenian1.src} alt="" />
						<div className="m-2 text-center bg-green-800 text-sm p-2 flex self-stretch items-start h-40">
							<div className="content-center">
					...
					<div>
						...
						<div className="m-2 text-center bg-cyan-800 text-sm p-2 flex self-stretch items-start h-40">
							<div className="content-center">
					...
					<div>
						<img src={vincenian3.src} alt="" />
						<div className="m-2 text-center bg-orange-800 text-sm p-2 flex self-stretch items-start h-40">
							<div className="content-center">
					...
					<div>
						...
						<div className="m-2 text-center bg-blue-800 text-sm p-2 flex self-stretch items-start h-40">
							<div className="content-center">
